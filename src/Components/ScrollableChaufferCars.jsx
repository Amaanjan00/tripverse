...
function ScrollableChaufferCars() {

    const packages = [
        {
            image: "abc",
            packagename: "Chauffer Package",
    ...
    <>
      <div className='px-0 py-5 mt-2 flex flex-col gap-2 md:pl-10'>
        ...
        <div className='px-5 md:px-10 flex flex-col w-fit gap-2'>
            <h1 className='uppercase text-2xl font-extrabold text-black'>Available Cars</h1>
...
export default ScrollableChaufferCars
